  ...
  const resetPassword = async () => {
    try {
      ...
      },
      {
        ...
        error: "You may have entered worng email id!"
      },
      {
        autoClose: 5000
      })
    ...
    <div className="h-[100vh] flex justify-center items-center bg-c1">
      ...
      <div className="flex items-center flex-col w-[600px]">
        ...
        <div className="flex justify-center gap-1 text-c3 mt-5">
          ...
          <Link href={"/register"} className="font-semibold text-white underline underline-offset-2 cursor-pointer">Register</Link>
        </div>
      </div>
    </div>
  );
